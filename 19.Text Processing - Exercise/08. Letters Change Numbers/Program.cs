...
// => [ A12b, s17G]
double sum = 0;
// step 2 foreach through all the ruslts in the array and do mathematical adding,
// substracting, dividing and mulitplying
...
foreach (string item in input)
{
    ...
    string numAsAString = item[1..^1]; // this will give us everything
                                       // that's between 0 and the last index; => 12
